...
const approveCmd = new Command("approve")
    ...
    .description("Claim")
    .option('--chainID <value>', "TODO")
    .option('--depositNonce <value>', 'TODO')
    .option('--amount <value>', 'TODO')
    .option('--recipient <address>', 'TODO', constants.relayerAddresses[4])
    .option('--resourceId <id>', 'TODO', constants.ERC20_RESOURCEID)
    .option('--bridge <address>', 'TODO', constants.BRIDGE_ADDRESS)
    .action(async function (args) {
        await setupParentArgs(args, args.parent.parent)
        ...
        // Make the deposit
        let tx = await bridgeInstance.executeProposal(
            args.chainID,
            args.depositNonce,
            data,
            args.resourceId,
