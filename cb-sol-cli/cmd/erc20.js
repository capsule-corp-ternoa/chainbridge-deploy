...
const claimCmd = new Command("claim")
    .description("Claim")
    .option('--chainID <value>', "ID of chain deposit originated from")
    .option('--depositNonce <value>', 'ID of deposited generated by origin Bridge contract')
    .option('--resourceID <id>', 'ResourceID to be used when making deposits')
    .action(async function (args) {
        await setupParentArgs(args, args.parent.parent)
